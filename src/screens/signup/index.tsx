    ...
    <>
      <div className={styles.pageLayout}>
        ...
        <div className={styles.signupBox}>
          <Typo color="#9F9F9F" variant="t3" className={styles.signupItemTitle}>
            아이디
          </Typo>
          <input
            type="text"
        ...
        <div className={styles.signupBox}>
          <Typo
            color="#9F9F9F"
            variant="t3"
            className={styles.signupItemTitle}
          ...
          {chk ? (
            <Typo
              ...
              bold
              variant="caption"
              className={styles.pwChk}
            >
              {" "}
              확인 완료!{" "}
            </Typo>
          ) : (
            <Typo color="red" bold variant="caption" className={styles.pwChk}>
              {" "}
              비밀번호가 일치하지 않습니다!{" "}
            </Typo>
          )}
